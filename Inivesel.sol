...
contract INIokenERC20 {
    string public constant _myTokeName = 'Inivesel Token';
    string public constant _mySymbol = 'FIN';
...
contract MyINIToken is owned, INITokenERC20 {
    ...
    function MyINIToken(
        ...
        string tokenName,
        string tokenSymbol
    ) INIokenERC20(initialSupply, tokenName, tokenSymbol) public {}
